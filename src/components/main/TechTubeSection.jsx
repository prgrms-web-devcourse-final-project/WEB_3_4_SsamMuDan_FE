  ...
  return (
    <>
      <div className="flex flex-col">
        {/* 제목 */}
        <div className="font-esamanru text-[25px] mt-[30px]"> 지금 HOT한 TechTube</div>
        {/* 카테고리 */}
        <div className="mt-[33px] flex flex-row justify-start gap-6 relative">
          {categoryList.map((item, index) => (
            ...
            >
              <Badge
                text={item}
                className={`w-[138px] h-[48px] text-2xl ${
